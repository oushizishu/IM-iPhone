...
typedef void(^BJImageLoadProgressBlock)(CGFloat process);

typedef void(^BJImageLoadCompletedBlock)(UIImage *image, NSError *error, BOOL finished);
...
- (void)loadUnderlyingImageOnlyLocal:(BOOL)flag progress:(BJImageLoadProgressBlock)progressBlock
                          completed:(BJImageLoadCompletedBlock)completedBlock ;
