...
@interface BJGridViewController () {
...
@implementation BJGridViewController
...
- (void)viewDidLoad {
    [super viewDidLoad];
    [self.collectionView registerClass:[BJGridCell class] forCellWithReuseIdentifier:@"GridCell"];
...
- (void)viewWillDisappear:(BOOL)animated {
    ...
    if (visibleCells) {
        for (BJGridCell *cell in visibleCells) {
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    BJGridCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"GridCell" forIndexPath:indexPath];
    if (!cell) {
        cell = [[BJGridCell alloc] init];
    }
    id <BJPicture> photo = [_browser thumbPhotoAtIndex:indexPath.row];
    cell.photo = photo;
...
- (void)collectionView:(UICollectionView *)collectionView didEndDisplayingCell:(UICollectionViewCell *)cell forItemAtIndexPath:(NSIndexPath *)indexPath {
    [((BJGridCell *)cell).photo cancelAnyLoading];
}
