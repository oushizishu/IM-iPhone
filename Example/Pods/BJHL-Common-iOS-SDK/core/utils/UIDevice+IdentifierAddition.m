...
- (NSString *) uniqueGlobalDeviceIdentifier{
    return [UIDevice getUUIDFromKeyChain];
...
+ (NSString *)getUUIDFromKeyChain
{
    ...
    NSString *keyChainGroup = [NSString stringWithFormat:@"%@.family", [UIDevice bundleSeedID] ];
    NSString *retrieveuuid = [SSKeychain passwordForService:keyChainService account:keyChainIdentifier accessGroup:keyChainGroup];
    
    if (retrieveuuid==nil||[retrieveuuid isEqualToString:@""])
    {
        NSString *did = [[UIDevice currentDevice].identifierForVendor UUIDString];
        [SSKeychain setPassword:did
